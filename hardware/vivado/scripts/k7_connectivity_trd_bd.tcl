...
proc create_hier_cell_reset_module { parentCell nameHier } {
  ...
  create_bd_pin -dir O -from 0 -to 0 -type rst peripheral_aresetn6
  create_bd_pin -dir O -from 0 -to 0 -type rst peripheral_aresetn7
  create_bd_pin -dir O -from 0 -to 0 -type rst peripheral_aresetn8
  create_bd_pin -dir O -from 0 -to 0 -type rst peripheral_aresetn9
  create_bd_pin -dir O -from 0 -to 0 -type rst peripheral_aresetn10
  create_bd_pin -dir O -from 0 -to 0 -type rst peripheral_aresetn11
...
proc create_hier_cell_PCIe_Path { parentCell nameHier } {
  ...
  create_bd_pin -dir I -from 0 -to 0 s_axi_areset_n
...
proc create_hier_cell_Ethernet_Path { parentCell nameHier } {
  ...
  create_bd_pin -dir I -from 0 -to 0 -type rst rx_axis_aresetn
  create_bd_pin -dir I -from 0 -to 0 -type rst rx_axis_aresetn1
  ...
  set_property -dict [ list CONFIG.FIFO_CNT_WIDTH {13} CONFIG.TDEST_VAL {3}  ] $rx_interface_1
...
proc create_hier_cell_DDR_Memory { parentCell nameHier } {
  ...
  # Create pins
  create_bd_pin -dir I -from 0 -to 0 -type rst M00_AXIS_ARESETN
  create_bd_pin -dir O -from 31 -to 0 -type data M00_AXIS_RD_DATA_COUNT
  create_bd_pin -dir I -from 0 -to 0 -type rst M01_AXIS_ARESETN
  create_bd_pin -dir O -from 31 -to 0 -type data M01_AXIS_RD_DATA_COUNT
  create_bd_pin -dir I -from 0 -to 0 -type rst M02_AXIS_ARESETN
  create_bd_pin -dir O -from 31 -to 0 -type data M02_AXIS_RD_DATA_COUNT
  create_bd_pin -dir I -from 0 -to 0 -type rst M03_AXIS_ARESETN
...
proc create_root_design { parentCell } {
  ...
  set user_reset_out [ create_bd_port -dir O -from 0 -to 0 -type rst user_reset_out ]
